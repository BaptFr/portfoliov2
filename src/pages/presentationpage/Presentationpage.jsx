    ...
    <div className='d-flex flex-fill flex-column'>
        ...
        <h1 className='gradient-title-blue-center'>PRESENTATION</h1>
            <article className='article  all-center'>
                <p className='text-shadow-outline' > Retrouvez sur cette page l&apos;ensemble de mes compétences ainsi que mon parcours professionnel.
                </p>
                <p>Vous pouvez découvrir mes projets ou me contacter via le menu.
                </p>
            </article>
            <div className='arrows-container' onClick={scrollToSection}>
        ...
        {/* Scroll ref for media queries small devices */}
        <div ref={topSectionRef} className='top-section-ref'> 
        </div>
        ...
        <section className={`${styles.formationSection} d-flex flex-column all-center gap-100`}>
            ...
            <div className={`${styles.timeline}`}>
                ...
                <div className={`${styles.timelineEmptyRight} d-flex flex-column justify-content-sb mt-5 mb-10`}>
                <p>Sept. 2023</p>
                <p>Sept. 2015</p>
                </div>
                <div className={styles.timelineMiddle}>
